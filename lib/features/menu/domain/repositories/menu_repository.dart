...
abstract class MenuRepository {
  ...
  Future<Either<Failure, List<MenuItemEntity>>> getMenuItems({int page, int pageSize, String? search, String? categoryId, List<String>? categoryIds, bool? isMostPopular, bool? isWeekendSpecial});
