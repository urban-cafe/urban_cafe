...
class _AdminEditScreenState extends State<AdminEditScreen> {
  ...
  final MenuRepository _repo = GetIt.I<MenuRepository>();
  ...
  Future<void> _loadInitialData() async {
    try {
      ...
      mainsResult.fold((failure) => debugPrint('Error loading mains: ${failure.message}'), (mains) {
