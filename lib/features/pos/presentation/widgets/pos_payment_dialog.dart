...
class _PosPaymentDialogState extends State<PosPaymentDialog> {
    ...
    return AlertDialog(
      title: const Row(
        children: [
          ...
          SizedBox(width: 8),
          Text('Payment', style: TextStyle(fontWeight: FontWeight.w700)),
        ],
      ),
      content: SizedBox(
        width: 340,
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(color: AppTheme.primaryContainer.withValues(alpha: 0.5), borderRadius: AppRadius.mdAll),
              child: Column(
                children: [
                  const Text('Total Amount', style: TextStyle(fontSize: 13, color: AppTheme.onSurfaceVariant)),
            ...
            if (_method == PosPaymentMethod.cash) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(color: _change > 0 ? const Color(0xFFE8F5E9) : AppTheme.surfaceVariant.withValues(alpha: 0.3), borderRadius: AppRadius.smAll),
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(fontWeight: FontWeight.w800, fontSize: 18, color: _change > 0 ? const Color(0xFF2E7D32) : AppTheme.onSurfaceVariant),
                    ),
                  ],
                ),
              ),
  ...
  List<double> get _quickAmounts {
    ...
    return [total, rounded.toDouble(), (rounded + 500).toDouble(), (rounded + 1000).toDouble()].toSet().take(4).toList();
  }
}
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            borderRadius: AppRadius.mdAll,
            border: Border.all(color: isSelected ? AppTheme.primary : AppTheme.outlineVariant, width: isSelected ? 2 : 1),
          ),
          child: Column(
            children: [
              Icon(icon, color: isSelected ? AppTheme.primary : AppTheme.onSurfaceVariant, size: 28),
              const SizedBox(height: 4),
              Text(
                method.label,
                style: TextStyle(fontWeight: isSelected ? FontWeight.w700 : FontWeight.w500, color: isSelected ? AppTheme.primary : AppTheme.onSurfaceVariant),
              ),
            ],
          ),
        ),
